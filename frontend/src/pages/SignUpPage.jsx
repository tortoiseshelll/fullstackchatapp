...
import { User, Mail, Lock, Eye, EyeOff, Loader2, Cat } from "lucide-react";
...
const SignUpPage = () => {
  ...
  const validateForm = () => {
    ...
    if (!formData.password) return toast.error("Gimme password");
    if (formData.password.length < 6)
      return toast.error("Gimme longer password");
  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2 ml-20">
